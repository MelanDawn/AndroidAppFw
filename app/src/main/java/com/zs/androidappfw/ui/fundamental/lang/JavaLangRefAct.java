...
public class JavaLangRefAct extends BaseTitleActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ClassInfoUtil.displayPackage(this, linearLayout, Utils.JAVA_LANG_REF_CLASSES_ALL);
    }

    @Override
    protected int getTitleResId() {
        return R.string.title_java_lang_ref;
    }
}
