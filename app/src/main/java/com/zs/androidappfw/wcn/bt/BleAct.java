...
public class BleAct extends BaseTitleActivity {
    ...
    private static class AdvertiseCb extends AdvertiseCallback {
        ...
        public void onStartSuccess(AdvertiseSettings settingsInEffect) {
            ...
            LUtil.d(TAG, "ble advertise cb:", settingsInEffect);
        }

        @Override
        public void onStartFailure(int errorCode) {
            super.onStartFailure(errorCode);
            LUtil.w(TAG, "ble advertise failed code:", errorCode);
        }
    }
    ...
    private static class AdvertisingSetCb extends AdvertisingSetCallback {
        ...
        public void onAdvertisingSetStarted(AdvertisingSet advertisingSet, int txPower, int status) {
            ...
            LUtil.d(TAG, "ble advertising set cb started:", advertisingSet, txPower, status);
        }

        @Override
        public void onAdvertisingSetStopped(AdvertisingSet advertisingSet) {
            super.onAdvertisingSetStopped(advertisingSet);
            LUtil.d(TAG, "ble advertising set cb stopped:", advertisingSet);
        }

        @Override
        public void onAdvertisingEnabled(AdvertisingSet advertisingSet, boolean enable, int status) {
            super.onAdvertisingEnabled(advertisingSet, enable, status);
            LUtil.d(TAG, "ble advertising set cb enabled:", advertisingSet, enable, status);
        }

        @Override
        public void onAdvertisingDataSet(AdvertisingSet advertisingSet, int status) {
            super.onAdvertisingDataSet(advertisingSet, status);
            LUtil.d(TAG, "ble advertising set cb data:", advertisingSet, status);
        }

        @Override
        public void onScanResponseDataSet(AdvertisingSet advertisingSet, int status) {
            super.onScanResponseDataSet(advertisingSet, status);
            LUtil.d(TAG, "ble advertising set cb response data:", advertisingSet, status);
        }
        ...
        public void onAdvertisingParametersUpdated(AdvertisingSet advertisingSet, int txPower, int status) {
            ...
            LUtil.d(TAG, "ble advertising set cb param updated:", advertisingSet, txPower, status);
        }
        ...
        public void onPeriodicAdvertisingParametersUpdated(AdvertisingSet advertisingSet, int status) {
            ...
            LUtil.d(TAG, "ble advertising set cb period param updated:", advertisingSet, status);
        }
        ...
        public void onPeriodicAdvertisingDataSet(AdvertisingSet advertisingSet, int status) {
            ...
            LUtil.d(TAG, "ble advertising set cb period data:", advertisingSet, status);
        }
        ...
        public void onPeriodicAdvertisingEnabled(AdvertisingSet advertisingSet, boolean enable, int status) {
            ...
            LUtil.d(TAG, "ble advertising set cb period enabled:", advertisingSet, enable, status);
        }
    }
    ...
    private static class ScanResultCb extends ScanCallback {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            LUtil.d(TAG, "ble scan cb result:", callbackType, result);
        }

        @Override
        public void onBatchScanResults(List<ScanResult> results) {
            super.onBatchScanResults(results);
            LUtil.d(TAG, "ble scan cb batch results:", results.size());
        }

        @Override
        public void onScanFailed(int errorCode) {
            super.onScanFailed(errorCode);
            LUtil.w(TAG, "ble scan failed code:", errorCode);
        }
    }
    ...
    private static class LeScanResultCb implements BluetoothAdapter.LeScanCallback {
        ...
        public void onLeScan(BluetoothDevice device, int rssi, byte[] scanRecord) {
            LUtil.d(TAG, device, rssi, scanRecord);
        }
    }
}
