...
//        }
        ...
        mSwitchStared = ResourcesCompat.getDrawable(getResources(), R.drawable.music_view_doing, null);
        mSwitchPaused = ResourcesCompat.getDrawable(getResources(), R.drawable.music_view_paused, null);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (MeasureSpec.EXACTLY == widthMode || MeasureSpec.EXACTLY == heightMode) {
            ...
            if (MeasureSpec.EXACTLY == widthMode && MeasureSpec.EXACTLY == heightMode) {
                ...
                mOutSideRadius -= Math.max(paddingHorizontal, paddingVertical);
